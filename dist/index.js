(function() {
    "use strict";
    fetch("https://api.myjson.com/bins/1geede").then(response => {
    ...
    function renderConversationDate(onlyTheDateWeNeed) {
      var dateOfConversation = document.getElementsByClassName("header-timestamp")[0];
      dateOfConversation.innerHTML = onlyTheDateWeNeed;
    }

    function renderMessages(message, index) {
      document.getElementsByClassName("text-for-dialogue")[index].innerHTML = message;
    }
    ...
    // FETCH 
    fetch("https://api.myjson.com/bins/1geede").then(function (response) {
      return response.json();
    }).then(function (myJson) {
      var _myJson$data = myJson.data;
      var conversationDate = _myJson$data.conversationDate;
      var messages = _myJson$data.messages;
    ...
    // Parsing functions
    function parseConversationDate(conversationDate) {
      var weekDayAbbrationObject = _defineProperty({
        Sun: "Sunday",
        Mon: "Monday",
        Tue: "Tuesday",
        Wed: "Wednesday",
